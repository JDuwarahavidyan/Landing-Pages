...
class AppTheme {
  ...
  static const TextStyle display1 = TextStyle( // headlineLarge -> display1
    fontFamily: fontName,
  ...
  static const TextStyle headline = TextStyle( // headlineMedium -> headline
    fontFamily: fontName,
    fontWeight: FontWeight.bold,
    fontSize: 24,
    letterSpacing: 0.27,
  ...
  static const TextStyle title = TextStyle( // headlineSmall -> title
    fontFamily: fontName,
    fontWeight: FontWeight.bold,
    fontSize: 16,
    letterSpacing: 0.18,
